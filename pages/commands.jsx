...
const commands = [
  ...
  return (
    <>
      ...
      <img width="500" src="/img/bck2.png" />
        ...
        You can get information about the commands of the AtlasBot.
        </p>
  ...
  <Link href={"https://discord.com/oauth2/authorize?client_id=898968789503332382"}>
...
Support Server</a>
  ...
  <Link href={"https://top.gg/bot/898968789503332382/vote"}>
  <a className={" px-6 justify-center gap-x-2 shadow-lg shadow-amber-600/20 rounded-xl py-4 font-medium bg-gradient-to-bl from-amber-700 to-amber-500 hover:opacity-80 transition duration-200 text-white " }>
Vote AtlasBot</a>
  </Link>
</div>
